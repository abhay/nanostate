...
4. **Verify data downloads work**: Run `uv run python data.py` to prep all datasets if needed.
...
**What you CAN do:**
- Modify `train.py` — this is the only file you edit. Everything is fair game: model architecture, SSM parameterization, optimizer, hyperparameters, training loop, initialization, gating, discretization, hybrid layers, etc.
