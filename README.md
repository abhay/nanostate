...
| 7.6723 | 42.6M | discard | SSD + compile + seq512 (1000 steps, no clear gain over individual) | `cd360d3` |
| 7.6925 | 42.6M | discard | SSD + compile + seq512 + C_SCALE=1.0 (no gain) | `cd360d3` |
| 7.807 | 42.2M | discard | hybrid attn@2 + compile + seq512 (worse than pure SSD) | `cd360d3` |
| 7.934 | 42.2M | discard | hybrid attn@0 + compile + seq512 (worst hybrid position) | `cd360d3` |
| 7.800 | 42.2M | discard | hybrid attn@3 + compile + seq512 (best hybrid pos, still worse) | `cd360d3` |
| 7.315 | 42.6M | keep | SSD + compile + seq512 5000 steps (best@3700=7.228) | `c802fd9` |
| 7.630 | 43.8M | discard | SSD + SwiGLU gating (same quality, 32% slower) | `c802fd9` |
| 7.812 | 42.7M | discard | SSD conv_k=8 (worse than k=4 by 0.14 bpb) | `c802fd9` |
| 7.676 | 42.6M | discard | SSD + B/C SiLU feature map (neutral on lm-tok) | `0f79501` |
| 7.593 | 42.7M | keep | SSD d_head=32 (24 heads) + B/C SiLU + seq512 | `ace2fef` |
...
| val_bpb | Params | Status | Description | Commit |
|---------|--------|--------|-------------|--------|
| 2.141 | 4.2M | keep | SSD + B/C SiLU feature map (NEW BYTE RECORD) | `0f79501` |
